...
| **2026-09-17** | **Upstream report FILED** — [#3510](https://github.com/x402-foundation/x402/issues/3510) and [#3511](https://github.com/x402-foundation/x402/issues/3511) against `x402-foundation/x402`. Preparing them corrected the report three times: the target repo was a fork with issues disabled, finding 2 overclaimed against a spec that does say what we said it did not, and both findings needed re-verifying. G9 reaches **6 of 7** — the demo video is the only row left, and it is the owner's. |
| **2026-09-17** | **G9 PASSED.** Demo video rendered and verified (`evidence/quittance_demo.mp4`, 1920x1080 24fps, H.264/AAC, 37.4 MB, 2m45s). Narrative shows the failure path first per PRD §23, structural checks only, and KeeperHub fee leg. `pnpm submission:check` exits 0 with all 7 of 7 rows passed. |
| **2026-09-18** | **G9 PASSED — 7 of 7.** Demo video recorded ([youtu.be/F8fvQNC44wE](https://youtu.be/F8fvQNC44wE), 4m58s, archival copy in `evidence/`). The row's check was gameable by a filename and now requires the artifact; the README's stated duration was wrong and now comes from `ffprobe`. **9 of 10 gates pass.** Only G6 remains, unbuilt and outside K8's protection order. |
